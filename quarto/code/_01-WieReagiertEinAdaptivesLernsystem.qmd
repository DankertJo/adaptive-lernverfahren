...
Diese Datei enthält den vollständigen Observable-JavaScript-(OJS)-Quellcode der interaktiven Simulation aus der Lernressource.
...
## 2. Definition der Beispielaufgaben

Hier werden die Beispielaufgaben mit ihren Startschwierigkeiten definiert.
...
## 3. Initialisierung des Modells

Festlegen der Anfangswerte des Lernenden sowie des internen Zustands des Elo-Modells.
```{ojs}
//| echo: false
...
## 4. Hilfsfunktionen und Erstellung des Verlaufsdiagramms

Dieses Kapitel enthält Hilfsfunktionen für
...
Erzeugung der grafischen Darstellung der Fähigkeits- und Schwierigkeitsentwicklung.
...
Definition der Auswahlfelder für die Aufgaben.
```{ojs}
//| echo: false
...
Implementierung des eigentlichen Elo-Updates nach einer richtigen oder falschen Bearbeitung.
```{ojs}
//| echo: false
...
Zusammensetzen aller Komponenten zur vollständigen interaktiven Simulation.
```{ojs}
//| echo: false
