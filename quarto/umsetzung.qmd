# Verfahren des adaptiven Lernens

## Grundlagen und Systematisierung

Adaptive Lernsysteme verfolgen das Ziel, Lerninhalte an die individuellen Voraussetzungen und den aktuellen Wissensstand von Lernenden anzupassen. Um eine solche Personalisierung zu ermöglichen, müssen sie Informationen über den aktuellen Wissensstand erfassen und auf dieser Grundlage geeignete Aufgaben, Lernpfade oder Lernressourcen auswählen. Verfahren des adaptiven Lernens bilden die algorithmische Grundlage dieser beiden Aufgaben und ermöglichen es, Lernprozesse dynamisch an den individuellen Lernfortschritt anzupassen [@Wang2025].

Die Vielfalt der Verfahren des adaptiven Lernens erschwert jedoch den Überblick über ihre unterschiedlichen Aufgaben, Modellierungsansätze und Einsatzgebiete. Für ein systematisches Verständnis lassen sich die Verfahren nach ihrer funktionalen Rolle innerhalb adaptiver Lernsysteme gliedern. Dabei wird zwischen Verfahren der Zustandsmodellierung und Verfahren der Adaptionsentscheidung unterschieden. 

Verfahren der Zustandsmodellierung dienen der Schätzung des aktuellen Wissensstands von Lernenden. Hierzu werden beobachtbare Lerndaten, beispielsweise bisherige Bearbeitungsergebnisse, Leistungsdaten oder Lernaktivitäten, ausgewertet, um den Wissensstand oder weitere lernendenbezogene Merkmale möglichst zuverlässig zu modellieren. Die resultierende Wissensstandsrepräsentation bildet die Grundlage für nachgelagerte adaptive Entscheidungen [@Desmarais2012; @Wang2025].

Verfahren der Adaptionsentscheidung bauen auf der zuvor ermittelten Wissensstandsrepräsentation auf. Sie nutzen die Informationen, um geeignete Aufgaben, Lernpfade, Lernressourcen oder andere Unterstützungsmaßnahmen auszuwählen und den weiteren Lernprozess individuell anzupassen. Auf diese Weise wird die Personalisierung der Lernumgebung auf Grundlage der Merkmale des jeweiligen Lernenden umgesetzt [@Wang2025].

Innerhalb der beiden Hauptklassen lassen sich unterschiedliche Verfahrensfamilien unterscheiden. Diese unterscheiden sich insbesondere hinsichtlich ihres zugrunde liegenden Modellierungsansatzes sowie der Art, wie sie den Wissensstand repräsentieren beziehungsweise adaptive Entscheidungen treffen. @fig-taxonomie zeigt die dieser Lernressource zugrunde liegende Systematisierung adaptiver Lernverfahren.

![Einordnung des Elo Ratings innerhalb der entwickelten Taxonomie adaptiver Lernverfahren. Quelle: Eigene Darstellung](/abbildungen/taxonomie_adaptive_lernverfahren2.svg){#fig-taxonomie fig-align="center" width=90% fig-pos="H"}

\
Die Verfahren der Zustandsmodellierung lassen sich in fünf Modellfamilien gliedern. Die wichtigsten Unterschiede zwischen diesen Modellfamilien sind in @tbl-zustandsmodellierung zusammengefasst.


| Modellfamilie | Art der Wissensrepräsentation | Charakteristik | Beispielverfahren |
|:---|:---|:---|:---|
| **Psychometrische Fähigkeitsmodelle** | Latente Fähigkeit | Präzise Schätzung eines aktuellen Fähigkeitsniveaus | Rasch-Modell, IRT |
| **Probabilistisch-temporale Wissensmodelle** | Beherrschung einzelner Wissenskomponenten | Modellieren den Lernverlauf einzelner Wissenskomponenten | Bayesian Knowledge Tracing (BKT) |
| **Logistische und online aktualisierte Performanzmodelle** | Performanz | Schätzen die Wahrscheinlichkeit einer korrekten Antwort auf Grundlage bisheriger Bearbeitungsergebnisse | Elo Rating, PFA, LFA |
| **Merkmalsbasierte Machine-Learning-Modelle** | Merkmalsbasierte Repräsentation | Nutzen explizit definierte Merkmale (*Features*) für Vorhersagen | Random Forest, SVM |
| **Deep Learning Models** | Latente Repräsentationen | Lernen latente Repräsentationen aus Interaktionsdaten | Deep Knowledge Tracing (DKT), Transformer |
: Überblick über die Modellfamilien der Zustandsmodellierung innerhalb der entwickelten Taxonomie adaptiver Lernverfahren {#tbl-zustandsmodellierung}
: Modellfamilien der Zustandsmodellierung innerhalb der entwickelten Taxonomie adaptiver Lernverfahren {#tbl-zustandsmodellierung}

Die Einordnung der Modellfamilien basiert auf der in dieser Arbeit entwickelten Systematisierung. Die Charakterisierung der einzelnen Modellfamilien orientiert sich an der zugrunde liegenden Fachliteratur [@Liu2024; @Han2018; @Shen2024;@Abdelrahman2023; @Pelanek2017;  @Wang2025; @Orji2022].

\
Auch die Verfahren der Adaptionsentscheidung lassen sich in verschiedene Modellfamilien gliedern. Sie unterscheiden sich insbesondere darin, nach welchen Strategien sie Aufgaben, Lernpfade oder Lernressourcen auf Grundlage der zuvor geschätzten Wissensstandsrepräsentation auswählen.


| Modellfamilie | Grundprinzip | Beispielverfahren |
|:---|:---|:---|
| **Regel- und wissensbasierte Adaptionsverfahren** | Auswahl geeigneter Aktionen anhand explizit definierter Regeln oder Wissensstrukturen | Regelbasierte Tutorensysteme, Expertensysteme |
| **Informationsmaximierende Selektionsverfahren** | Auswahl der Aufgabe mit dem größten erwarteten diagnostischen Informationsgewinn | Maximum Fisher Information, Kullback-Leibler-Auswahl |
| **Ressourcenempfehlung** | Empfehlung geeigneter Lernressourcen oder Aufgaben auf Grundlage ihrer erwarteten Relevanz oder Passung | Content-basierte, kollaborative und hybride Recommender |
| **Lernpfadempfehlung und Sequenzplanung** | Planung vollständiger personalisierter Lernpfade unter Berücksichtigung zeitlicher und inhaltlicher Abhängigkeiten | Course Generation, Course Sequence, Sequential Pattern Recognition |
| **Sequentielle Entscheidungsoptimierung** | Lernen, welche Entscheidung in jeder Situation langfristig den größten Lernerfolg erzielt | Kontextuelle Bandits, Q-Learning, Deep Q-Networks (DQN), PPO |
: Überblick über die Modellfamilien der Adaptionsentscheidung {#tbl-adaptionsentscheidung}


Die Einordnung der Modellfamilien basiert auf der in dieser Arbeit entwickelten Systematisierung. Die Charakterisierung der einzelnen Modellfamilien orientiert sich an der zugrunde liegenden Fachliteratur [@Wang2025; @Liu2024; @daSilva2023; @Nabizadeh2020; @Riedmann2025].

Die vorgeschlagene Klassifikation versteht sich als funktionale Systematisierung adaptiver Lernverfahren. Einzelne Verfahren können Merkmale mehrerer Modellfamilien aufweisen oder verschiedene Ansätze miteinander kombinieren. Die Zuordnung erfolgt daher nach der jeweils dominierenden Funktion eines Verfahrens innerhalb des adaptiven Lernsystems.

Im Folgenden wird mit dem Elo Rating exemplarisch ein Vertreter der logistischen und online aktualisierten Performanzmodelle vorgestellt. Aufgrund seiner vergleichsweise einfachen Modellstruktur eignet sich dieses Verfahren besonders gut, um die grundlegenden Prinzipien der Zustandsmodellierung in adaptiven Lernsystemen nachzuvollziehen.
...
- die Grundidee des Elo Ratings erläutern,
...
- typische Einsatzgebiete sowie Grenzen und Erweiterungen des Elo Ratings beschreiben.
...
|:---|:---|:---|:---|
| **Zielgruppe** | Für Lernende, die zunächst verstehen möchten, welches Problem das Elo Rating löst und wie es grundsätzlich funktioniert. | Für Lernende, die die mathematischen Grundlagen und den Aktualisierungsmechanismus nachvollziehen möchten. | Für Lernende, die das Verfahren praktisch in Python umsetzen möchten. |
| **Inhalte** | Motivation, Grundidee des Elo Ratings, interaktives Experiment, Ablauf des Algorithmus, Einsatzgebiete | Erfolgswahrscheinlichkeit, Aktualisierungsregeln, Zahlenbeispiel, interaktive Simulation | Python-Implementierung, Funktionen, Codebeispiele, interaktive Programmieraufgaben, Optionale Vertiefung: Grenzen und Erweiterungen |
...
## Das Elo Rating als Verfahren der Zustandsmodellierung {#konzeptueller-zugang}

**Lernziele dieses Abschnitts**

Nach diesem Abschnitt können Sie

- erläutern, weshalb das Elo Rating zur Lernstandsschätzung eingesetzt werden kann,
- die Grundidee und den grundlegenden Ablauf des Elo Ratings beschreiben,
- typische Einsatzgebiete des Elo Ratings in adaptiven Lernsystemen erläutern,
- die Rolle des Elo Ratings bei adaptiven Entscheidungen erläutern.

\

Innerhalb der verschiedenen Verfahren zur Zustandsmodellierung zählen logistische und online aktualisierte Performanzmodelle zu den Ansätzen, die den Wissensstand eines Lernenden nach jeder neuen Bearbeitung kontinuierlich aktualisieren. Ein besonders bekannter Vertreter dieser Modellfamilie ist das Elo Rating. Es wurde ursprünglich zur Bewertung von Schachspielern entwickelt und später für zahlreiche weitere Anwendungsgebiete – darunter auch adaptive Lernsysteme – weiterentwickelt [@Elo1978; @Abdi2019].

Im Vergleich zu vielen komplexeren Modellierungsansätzen zeichnet sich das Elo Rating durch eine vergleichsweise einfache Struktur sowie die Möglichkeit einer kontinuierlichen Aktualisierung aus. Diese Eigenschaften machen es für den Einsatz in digitalen Lernumgebungen interessant und haben dazu geführt, dass Elo-basierte Verfahren in der Literatur als geeignete Ansätze zur Lernendenmodellierung diskutiert werden [@Pelanek2016; @Abdi2019].

### Experiment: Wie reagiert ein adaptives Lernsystem?

Bevor die Funktionsweise des Elo Ratings erläutert wird, können Sie dessen Grundidee zunächst selbst erkunden. Im folgenden Experiment beobachten Sie an einer festen Beispielaufgabe, wie ein adaptives Lernsystem seine Einschätzung eines Lernenden sowie der Aufgabenschwierigkeit nach jeder Bearbeitung aktualisiert.
...
::: {.content-visible when-format="pdf"}
**// Definition der festen Beispielaufgabe:** Dieser Block definiert die Beispielaufgabe und ihren Startwert für die Schwierigkeitsschätzung.
:::
...
::: {.content-visible when-format="pdf"}
**// Feste Aufgaben-ID:** Dieser Block legt fest, dass das Experiment immer mit derselben Beispielaufgabe arbeitet.
:::
...
Doch warum reagiert das System auf diese Weise? Um diese Frage zu beantworten, lohnt sich ein Blick auf den Ursprung des Elo Ratings. Die Grundidee entstand ursprünglich im Schachsport und bildet bis heute die Grundlage vieler Elo-basierter Verfahren in adaptiven Lernsystemen.
...
Die grundlegende Idee des Elo Ratings lässt sich somit auf drei einfache Schritte zurückführen:
...
Diese drei Schritte bilden den Kern des Elo Ratings und werden im weiteren Verlauf der Lernressource zunächst algorithmisch und anschließend wahlweise auch mathematisch genauer betrachtet.

### Algorithmische Funktionsweise des Elo Ratings

Im Experiment konnten Sie beobachten, wie ein adaptives Lernsystem seine Einschätzungen nach jeder bearbeiteten Aufgabe aktualisiert. Im vorherigen Abschnitt wurde anschließend die Grundidee dieses Vorgehens anhand des Elo Ratings aus dem Schachsport erläutert. Im Folgenden wird dieser Aktualisierungsprozess Schritt für Schritt beschrieben.
...
Der algorithmische Ablauf des Elo Ratings lässt sich somit in fünf Schritte zusammenfassen:
...
Diese fünf Schritte werden nach jeder bearbeiteten Aufgabe erneut durchlaufen und bilden den grundlegenden Arbeitsablauf des Elo Ratings. Im nächsten Abschnitt werden die verschiedenen Anwendungsbereiche des Verfahrens in adaptiven Lernsystemen näher betrachtet.

### Anwendungen des Elo Ratings in adaptiven Lernsystemen

Das Elo Rating wird in adaptiven Lernsystemen vor allem zur Schätzung von Fähigkeits- und Schwierigkeitswerten eingesetzt. Dabei wird jede Interaktion zwischen einem Lernenden und einer Aufgabe als Beobachtung genutzt, um die zugrunde liegenden Parameter fortlaufend zu aktualisieren. Durch diese kontinuierliche Aktualisierung eignet sich das Verfahren insbesondere für Systeme, die den Wissensstand von Lernenden während des Lernprozesses modellieren möchten [@Pelanek2016].

#### Lernendenmodellierung

Eine zentrale Anwendung des Elo Ratings besteht in der Schätzung der Fähigkeiten von Lernenden. Nach jeder bearbeiteten Aufgabe wird die Fähigkeitsbewertung anhand des beobachteten Ergebnisses aktualisiert. Dadurch entsteht ein dynamisches Modell des aktuellen Wissensstands, das sich kontinuierlich an neue Beobachtungen anpasst [@Pelanek2016].
...
Wie in @fig-elo-einordnung dargestellt, können die geschätzten Fähigkeits- und Schwierigkeitswerte anschließend als Grundlage adaptiver Entscheidungen dienen. Beispielsweise können Lernsysteme Aufgaben auswählen, deren Schwierigkeit zum aktuellen Leistungsstand eines Lernenden passt. Die eigentliche Aufgabenwahl ist dabei nicht Bestandteil des Elo Ratings selbst, sondern nutzt die durch das Verfahren bereitgestellten Schätzwerte [@Pelanek2016].
Ein Beispiel hierfür beschreiben Vesin et al., die ein modifiziertes Elo Rating in Online-Programmierkursen einsetzen, um sowohl den Wissensstand der Lernenden als auch die Schwierigkeit von Programmieraufgaben zu schätzen und darauf aufbauend geeignete Lerninhalte zu empfehlen [@Vesin2022].

![Schematische Einordnung des Elo Ratings in den adaptiven Entscheidungsprozess. Quelle: Eigene Darstellung nach @Vesin2022.](/abbildungen/RATING-adaptiver-entscheidungsprozess-elo.jpg){#fig-elo-einordnung width=70% fig-pos="H"}
...
Die dargestellten Anwendungsbereiche verdeutlichen, dass das Elo Rating nicht nur zur Schätzung von Fähigkeiten eingesetzt werden kann, sondern auch die Grundlage verschiedener adaptiver Funktionen in modernen Lernsystemen bildet.

### Wissensüberprüfung

Beantworten Sie die folgenden Fragen, bevor Sie zur mathematischen Herleitung übergehen. Wählen Sie jeweils eine Antwort aus und prüfen Sie diese anschließend über den Button. Die Gesamtauswertung erscheint, sobald alle Fragen geprüft wurden.
...
::: {.content-visible when-format="pdf"}
**// Eingabeelemente:** Dieser Block erzeugt die Radio-Button-Eingaben und einen Prüfen-Button für jede Multiple-Choice-Frage.
:::
...
::: {.content-visible when-format="pdf"}
**// Auswertung:** Dieser Block sammelt die geprüften Antworten, berechnet den Punktestand und erzeugt Gesamt- und Detailfeedback.
:::
...
Möchten Sie tiefer in das Elo Rating einsteigen?
...
* Die Implementierung zeigt, wie sich das Elo Rating Schritt für Schritt in Python umsetzen lässt. → [Zum Implementierungszugang](#implementierungszugang)
:::

## Mathematische Modellierung im Elo Rating {#formaler-zugang}
...
* nachvollziehen, wie das Elo Rating seine Schätzwerte nach jeder Bearbeitung aktualisiert.
...
Damit ein adaptives Lernsystem den Wissensstand eines Lernenden abschätzen kann, muss es dessen Beobachtungen mathematisch beschreiben. Das Elo Rating modelliert dazu zwei zentrale Größen: die geschätzte Fähigkeit eines Lernenden und die geschätzte Schwierigkeit einer Aufgabe. Beide Werte werden nach jeder bearbeiteten Aufgabe anhand des beobachteten Ergebnisses aktualisiert und bilden die Grundlage für alle weiteren Berechnungen [@Pelanek2016; @Elo1978].
...
Im Folgenden wird zunächst gezeigt, wie das Elo Rating diese Erfolgswahrscheinlichkeit mathematisch berechnet. Anschließend wird erläutert, wie die Schätzwerte nach einer bearbeiteten Aufgabe aktualisiert werden.
...
| Symbol | Bedeutung |
|----------|----------|
| $P_{si}$ | erwartete Erfolgswahrscheinlichkeit für Lernenden $s$ und Aufgabe $i$ |
| $\theta_s$ | Fähigkeit des Lernenden $s$ |
| $d_i$ | Schwierigkeit der Aufgabe $i$ |
...
Nachdem die erwartete Erfolgswahrscheinlichkeit berechnet wurde, stellt sich die nächste Frage: Wie passt das Elo Rating seine Schätzungen an, nachdem das tatsächliche Ergebnis bekannt ist?
...
| Symbol | Bedeutung |
|----------|----------|
| $\theta_s'$ | aktualisierte Fähigkeit des Lernenden $s$ |
| $\theta_s$ | bisherige Fähigkeit des Lernenden $s$ |
| $d_i'$ | aktualisierte Schwierigkeit der Aufgabe $i$ |
| $d_i$ | bisherige Schwierigkeit der Aufgabe $i$ |
| $correct_{si}$ | tatsächliches Ergebnis von Lernendem $s$ bei Aufgabe $i$ (0 = falsch, 1 = richtig) |
| $P_{si}$ | erwartete Erfolgswahrscheinlichkeit für Lernenden $s$ und Aufgabe $i$ |
...
Nach der Aktualisierung wird der Lernende somit etwas stärker und die Aufgabe etwas leichter eingeschätzt als zuvor. Das Elo Rating berücksichtigt dadurch die neue Information, dass ein unerwartet gutes Ergebnis erzielt wurde.
...
Beantworten Sie die folgenden Fragen, bevor Sie zur Implementierung des Elo Ratings übergehen. Wählen Sie jeweils eine Antwort aus und prüfen Sie diese anschließend über den Button. Die Gesamtauswertung erscheint, sobald alle Fragen geprüft wurden.
...
eloMathQuizQuestions = [
  {
    ...
    prompt: "Wovon hängt die erwartete Erfolgswahrscheinlichkeit im Elo Rating hauptsächlich ab?",
    correct: "mq1-c",
    options: [
...
::: {.content-visible when-format="pdf"}
**// Eingabeelemente:** Dieser Block erzeugt die Radio-Button-Eingaben und einen Prüfen-Button für die einzelnen Fragen.
:::
...
::: {.content-visible when-format="pdf"}
**// Auswertung:** Dieser Block sammelt die geprüften Antworten, berechnet das Ergebnis und erzeugt Gesamt- und Detailfeedback.
:::
...
eloMathQuizEvaluations = [
  ...
  },
  {
    level: "reached",
    title: "✅ Lernziel erreicht.",
    text: "Sie haben die zentralen Konzepte der mathematischen Modellierung des Elo Ratings verstanden und können mit der Implementierung fortfahren."
  }
]
...
{
const eloMathQuizContainer = html`
<div class="elo-quiz">
  <h4>Kurzer Selbsttest</h4>
  <div class="elo-quiz-grid">
  ...
  ${!eloMathQuizComplete
    ? html`<div class="elo-quiz-result pending">Prüfen Sie alle vier Fragen, um eine Gesamtrückmeldung zu erhalten.</div>`
    : html`
      <div class="elo-quiz-summary">
        <div class="elo-quiz-score">
...
const resetAllButton = eloMathQuizContainer.querySelector(".elo-quiz-reset-all")
resetAllButton.addEventListener("click", () => {
  [viewof eloMathQuizQ1, viewof eloMathQuizQ2, viewof eloMathQuizQ3, viewof eloMathQuizQ4]
    .forEach(questionForm => {
      if (typeof questionForm.resetQuestion === "function") questionForm.resetQuestion()
    })
})

return eloMathQuizContainer
}
```
...
* Der konzeptuelle Zugang fasst die Grundidee und typische Einsatzgebiete des Elo Ratings ohne mathematische Herleitungen zusammen. → [Zum konzeptuellen Zugang](#konzeptueller-zugang)
...
## Implementierung des Elo Ratings {#implementierungszugang}

**Lernziele** 

Nach Abschluss dieses Kapitels können Sie …

* erläutern, wie die zentralen Berechnungsschritte des Elo Ratings in Programmcode umgesetzt werden.
...
Die Variable theta speichert also die aktuelle Fähigkeit des Lernenden, während difficulty die Schwierigkeit der betrachteten Aufgabe repräsentiert. Diese Werte entsprechen den mathematischen Größen $\theta_s$ und $d_i$, die im Elo Rating verwendet werden.
...
Nachdem die erwartete Erfolgswahrscheinlichkeit berechnet wurde, folgt der zweite Schritt des Elo Ratings: die Aktualisierung der Fähigkeit des Lernenden und der Schwierigkeit der bearbeiteten Aufgabe. Die zugrunde liegenden Gleichungen lassen sich nahezu direkt in Python übertragen.
...
Nachdem sowohl die Berechnung der erwarteten Erfolgswahrscheinlichkeit als auch die Aktualisierung implementiert wurden, können beide Funktionen nun gemeinsam verwendet werden. Dadurch lässt sich ein vollständiger Aktualisierungsschritt des Elo Ratings mit wenigen Codezeilen ausführen.
...
Mit wenigen Codezeilen lässt sich somit ein vollständiger Aktualisierungsschritt des Elo Ratings durchführen. Nach jeder bearbeiteten Aufgabe werden die Fähigkeit des Lernenden und die Schwierigkeit der Aufgabe aktualisiert und können unmittelbar für die nächste Bearbeitung verwendet werden.
...
In den vorherigen Abschnitten wurden die einzelnen Bestandteile des Elo Ratings schrittweise entwickelt. Der folgende Codeblock fasst diese Bestandteile zu einer vollständigen, lauffähigen Python-Implementierung zusammen.
...
def update(theta, difficulty, result, k=0.1):
    """Aktualisiert Fähigkeit und Aufgabenschwierigkeit."""

    p = probability(theta, difficulty)

    theta = theta + k * (result - p)
    difficulty = difficulty + k * (p - result)
...
print("Neue Fähigkeit:", round(theta, 3))
print("Neue Schwierigkeit:", round(difficulty, 3))
```

Die Implementierung fasst die zuvor entwickelten Bestandteile des Standard Elo Ratings zu einem vollständigen Python-Programm zusammen. Sie kann direkt ausgeführt und als Ausgangspunkt für eigene Experimente oder Erweiterungen verwendet werden.

Die vorgestellte Implementierung bildet das Standard Elo Rating ab. In modernen adaptiven Lernsystemen werden jedoch häufig Erweiterungen eingesetzt, um beispielsweise Unsicherheiten, Bearbeitungszeiten oder mehrere Wissenskomponenten zu berücksichtigen. Diese Erweiterungen sowie die Grenzen des Standardmodells werden im anschließenden Vertiefungsabschnitt vorgestellt.

::: {.callout-note title="Weiterer Zugang"}
Möchten Sie das Verfahren aus einer anderen Perspektive betrachten?

* Der konzeptuelle Zugang erläutert Motivation, Grundidee und typische Anwendungsgebiete des Elo Ratings. → [Zum konzeptuellen Zugang](#konzeptueller-zugang)
* Der formale Zugang erklärt die mathematischen Grundlagen und den Aktualisierungsmechanismus des Elo Ratings. → [Zum formalen Zugang](#formaler-zugang)
:::

## Grenzen und Erweiterungen des Elo Ratings

**Lernziele dieses Abschnitts**

Nach diesem Abschnitt können Sie

- die wichtigsten Grenzen des Standard Elo Ratings erläutern,
- erklären, weshalb verschiedene Erweiterungen des Elo Ratings entwickelt wurden,
...
- die grundlegenden Unterschiede zwischen dem Standard Elo Rating und seinen Erweiterungen erläutern.

### Grenzen des Standard Elo Ratings

Das Elo Rating bietet eine vergleichsweise einfache und effiziente Möglichkeit zur Modellierung von Lernenden und Aufgaben. Insbesondere die kontinuierliche Aktualisierung nach jeder Interaktion sowie die geringe Anzahl benötigter Parameter machen das Verfahren für adaptive Lernsysteme attraktiv [@Pelanek2016]. Dennoch weist das Standard Elo Rating mehrere Einschränkungen auf, die seine Aussagekraft in komplexen Bildungsszenarien begrenzen können.
...
Schließlich basiert das Standard Elo Rating in seiner einfachsten Form auf binären Ergebnissen. Antworten werden lediglich als korrekt oder inkorrekt betrachtet. In realen Bildungssystemen treten jedoch häufig komplexere Situationen auf, beispielsweise Multiple-Choice-Aufgaben mit Ratewahrscheinlichkeit, Teilpunktebewertungen, Hinweissysteme oder die Berücksichtigung von Bearbeitungszeiten. Diese Informationen können durch das Grundmodell nur eingeschränkt genutzt werden [@Pelanek2016; @Abdi2019].
...
Aus diesen Gründen wurden verschiedene Erweiterungen des Elo Ratings entwickelt, die versuchen, einzelne Schwächen des Standardmodells zu adressieren. Im folgenden Abschnitt wird zunächst die Verwendung von Unsicherheitsfunktionen als Alternative zu einem konstanten Aktualisierungsparameter betrachtet.

### Unsicherheitsfunktionen

Im Standard Elo Rating wird die Stärke der Aktualisierung durch den konstanten Parameter $K$ bestimmt. Dieser Parameter beeinflusst, wie stark neue Beobachtungen die Bewertungen verändern. Die Wahl eines geeigneten Wertes stellt dabei einen Kompromiss dar: Kleine Werte führen zu stabilen, aber langsamen Anpassungen, während große Werte schnelle Reaktionen ermöglichen, jedoch zu stärkeren Schwankungen der Schätzwerte führen können.
...
Die Verwendung von Unsicherheitsfunktionen stellt somit eine vergleichsweise einfache Erweiterung des Elo Ratings dar, die insbesondere in frühen Phasen der Schätzung eine schnellere Anpassung ermöglicht und gleichzeitig langfristig stabilere Bewertungen erzeugt.
...
Dabei bezeichnet $U(n)$ die Aktualisierungsstärke in Abhängigkeit von der Anzahl der bereits beobachteten Antworten $n$.
...
Dabei bezeichnet $P(\text{korrekt})$ die erwartete Wahrscheinlichkeit einer korrekten Antwort, $k$ die Anzahl der Antwortmöglichkeiten, $\theta$ die Fähigkeit des Lernenden und $d$ die Schwierigkeit der Aufgabe. Der erste Term berücksichtigt die Wahrscheinlichkeit eines zufälligen Treffers, während der zweite Term den eigentlichen Einfluss von Fähigkeit und Aufgabenschwierigkeit beschreibt [@Pelanek2016]. Dadurch wird die Erfolgswahrscheinlichkeit insbesondere bei sehr schwierigen Aufgaben realistischer modelliert.

Die folgende interaktive Simulation veranschaulicht diesen Zusammenhang. Durch das Ein- und Ausschalten der Berücksichtigung der Ratewahrscheinlichkeit lässt sich direkt beobachten, wie sich die geschätzte Erfolgswahrscheinlichkeit im Vergleich zum Standard Elo Rating verändert.
...
Neben Ratewahrscheinlichkeiten stellen Teilpunkte eine weitere Herausforderung für das Standard Elo Rating dar. Viele Aufgaben liefern nicht nur die Information, ob eine Lösung richtig oder falsch ist, sondern erlauben eine abgestufte Bewertung. Dies betrifft beispielsweise Programmieraufgaben, mathematische Aufgaben mit mehreren Zwischenschritten oder komplexe Problemlöseaufgaben. Ein Lernender kann dabei einen Teil der Aufgabe erfolgreich bearbeiten, ohne die vollständige Lösung zu erreichen.
Da das Elo Rating ursprünglich nicht auf binäre Ergebnisse beschränkt ist, können solche Teilbewertungen vergleichsweise einfach integriert werden. Anstelle der Werte 0 oder 1 wird die Erfolgsvariable als kontinuierlicher Wert zwischen 0 und 1 interpretiert. Eine Aufgabe, bei der 75 % der möglichen Punkte erreicht werden, kann beispielsweise mit einem Erfolgswert von

$$
S = 0.75
$$

in die Aktualisierung eingehen. Dabei steht $S$ für den beobachteten Erfolgswert der Lerninteraktion. Die grundlegende Struktur der Elo-Gleichungen bleibt dabei unverändert. Lediglich die Definition des beobachteten Ergebnisses wird erweitert [@Pelanek2016].
...
<div class="success-value-demo">
  ...
  <p>Das Elo Rating kann statt eines reinen Richtig-Falsch-Ergebnisses auch einen kontinuierlichen Erfolgswert verwenden. Verändern Sie Punkte und Hinweise, um zu sehen, wie daraus ein Wert zwischen 0 und 1 entsteht.</p>
  ...
  <div class="success-grid">
    ...
    <div class="success-card success-result-card">
      <div class="success-result-label">Vom Elo Rating verwendeter Erfolgswert</div>
...
Analog zum klassischen Elo Rating besitzt jeder Lernende einen Fähigkeitsparameter $\theta_s$ und jede Aufgabe einen Schwierigkeitsparameter $d_p$. Anstelle einer Erfolgswahrscheinlichkeit wird jedoch die erwartete logarithmierte Bearbeitungszeit modelliert [@Pelanek2016]:
...
Der in der Simulation dargestellte Vorhersagefehler veranschaulicht das Grundprinzip des Zeit-Elo Ratings. Im mathematischen Modell ergibt er sich aus der Differenz zwischen der erwarteten logarithmierten Bearbeitungszeit $E(t \mid s,p)$ und der beobachteten logarithmierten Bearbeitungszeit $t_{sp}$. Diese Differenz bildet die Grundlage für die Aktualisierung der Fähigkeits- und Schwierigkeitsparameter gemäß den Gleichungen (7) und (8).

Nachdem die tatsächliche Bearbeitungszeit $t_{sp}$ beobachtet wurde, können die Parameter ähnlich wie im klassischen Elo Rating aktualisiert werden [@Pelanek2016]:
...
| Symbol | Bedeutung |
|----------|----------|
| $E(t \mid s,p)$ | erwartete logarithmierte Bearbeitungszeit von Lernendem $s$ bei Aufgabe $p$ |
| $t_{sp}$ | beobachtete logarithmierte Bearbeitungszeit von Lernendem $s$ bei Aufgabe $p$ |
| $\theta_{s,\text{alt}}$ | bisherige Fähigkeit des Lernenden $s$ |
| $\theta_{s,\text{neu}}$ | aktualisierte Fähigkeit des Lernenden $s$ |
| $d_{p,\text{alt}}$ | bisherige Schwierigkeit der Aufgabe $p$ |
| $d_{p,\text{neu}}$ | aktualisierte Schwierigkeit der Aufgabe $p$ |
| $K$ | Anpassungs- bzw. Lernrate |
...
Aus diesem Grund wurden multivariate Erweiterungen des Elo Ratings entwickelt. Ein früher Vertreter multivariater Elo-Modelle ist der Multivariate Elo-type Algorithm (META) von Doebler et al. Im Gegensatz zum klassischen Elo Rating wird dabei nicht nur ein einzelner Fähigkeitswert, sondern mehrere miteinander zusammenhängende Fähigkeitsdimensionen gleichzeitig modelliert. Dieses Grundprinzip wurde später von Pelánek auf adaptive Lernsysteme übertragen, indem die Kompetenz eines Lernenden durch mehrere Wissenskomponenten beschrieben wird. Jeder dieser Parameter repräsentiert einen bestimmten Wissensbereich oder eine einzelne Kompetenz. Im Bereich der Mathematik könnten dies beispielsweise Bruchrechnung, Polynome oder trigonometrische Funktionen sein [@Doebler2014; @Pelanek2016].
...
.multi-elo-arrow-head {
  ...
  border-left: 0.75rem solid #64748b;
...
Dabei bezeichnet $\theta_{sj}$ die Fähigkeit des Lernenden $s$ im Wissensbereich $j$. Der Faktor $c_{ij}$ beschreibt die Korrelation zwischen den Wissenskomponenten $i$ und $j$. Der Ausdruck $correct$ steht für das beobachtete Ergebnis der bearbeiteten Aufgabe, während $P(correct = 1)$ die erwartete Wahrscheinlichkeit einer korrekten Antwort bezeichnet. Der Parameter $K$ bestimmt die Stärke der Aktualisierung. Eine korrekte oder inkorrekte Antwort auf eine Aufgabe des Konzepts $i$ beeinflusst somit nicht nur die Schätzung für dieses Konzept selbst, sondern gegebenenfalls auch die Bewertungen verwandter Wissensbereiche. Für die direkt bearbeitete Wissenskomponente gilt $c_{ii}=1$, sodass der vollständige Aktualisierungsschritt übernommen wird. [@Pelanek2016].

Anschaulich bedeutet dies, dass Lernfortschritte in einem Themengebiet Hinweise auf den Wissensstand in verwandten Bereichen liefern können. Beherrscht ein Lernender beispielsweise grundlegende algebraische Verfahren, lässt dies häufig auch Rückschlüsse auf Kompetenzen in verwandten mathematischen Themen zu. Multivariate Elo-Modelle nutzen solche Zusammenhänge, um differenziertere Fähigkeitsprofile zu erzeugen als das eindimensionale Standard Elo Rating.

Der zusätzliche Informationsgewinn geht jedoch mit einer höheren Modellkomplexität einher. Im Vergleich zum Standard-Elo müssen nicht nur mehrere Fähigkeitswerte modelliert, sondern auch Aufgaben den einzelnen Wissenskomponenten zugeordnet sowie Beziehungen zwischen diesen Wissenskomponenten definiert werden [@Pelanek2016]. Dadurch steigen der Modellierungs- und Implementierungsaufwand gegenüber dem Standard-Elo deutlich. Neuere Arbeiten weisen zudem darauf hin, dass insbesondere die Definition und Pflege der zugrunde liegenden Wissensstruktur mit erheblichem Aufwand verbunden sein kann, insbesondere bei großen Aufgabenpools. Darüber hinaus benötigen multidimensionale Elo-Modelle mehr Beobachtungen, um stabile Schätzwerte zu erreichen, und liefern in der Anfangsphase teilweise weniger präzise Vorhersagen als einfachere Elo-Varianten [@Vermeiren2025].

Simulationen von Doebler et al. zeigen, dass der Einbezug korrelierter Merkmale im META gegenüber mehreren unabhängigen univariaten Elo-Algorithmen zu einer effizienteren Schätzung führen kann [@Doebler2014].  Auch aktuelle Arbeiten unterstreichen die praktische Relevanz multivariater Elo-Modelle. So passen Kandemir et al. ein mehrdimensionales Elo Rating an die Daten einer medizinischen Lernplattform an, deren Aufgaben mehreren Wissenskomponenten zugeordnet sind. Die Autoren heben hervor, dass das Verfahren die Schätzung kompetenzbezogener Fähigkeitswerte unterstützt und damit für adaptive Lernumgebungen mit mehreren Wissensbereichen geeignet ist [@Kandemir2024].  
...
Die bisher betrachteten Erweiterungen des Elo Ratings verbessern vor allem die Schätzung des aktuellen Wissensstands von Lernenden. Dabei bleibt jedoch eine grundlegende Annahme des klassischen Elo-Modells bestehen: Antworten werden ausschließlich als Beobachtungen bereits vorhandenen Wissens interpretiert. Eine korrekte Antwort liefert Hinweise auf eine hohe Fähigkeit, während eine falsche Antwort auf Wissensdefizite hindeutet.
...
.pfae-slider-row input[type="range"]:disabled {
  cursor: not-allowed;
}
...
<div class="pfae-demo">
  ...
  <p>Lisa bearbeitet eine Aufgabe. Wählen Sie aus, ob ihre Antwort korrekt oder inkorrekt war, und verändern Sie die jeweils aktive Lernrate. Beobachten Sie, wie sich die Fähigkeitsschätzung von Lisa nach der Lerninteraktion verändert und vergleichen Sie die Auswirkungen beider Antwortmöglichkeiten.</p>
  ...
  <div class="pfae-grid">
    <div class="pfae-card">
      ...
      <div class="pfae-slider-group">
        <div class="pfae-slider-row pfae-gamma-row">
          <label>
        ...
        <div class="pfae-slider-row pfae-delta-row">
          <label>
...
const pfaeGammaRow = pfaeDemoContainer.querySelector(".pfae-gamma-row")
const pfaeDeltaRow = pfaeDemoContainer.querySelector(".pfae-delta-row")
...
const updatePfaeDemo = () => {
  ...
  pfaeGammaSlider.disabled = !isCorrectAnswer
  pfaeDeltaSlider.disabled = isCorrectAnswer
  pfaeGammaRow.classList.toggle("inactive", !isCorrectAnswer)
  pfaeDeltaRow.classList.toggle("inactive", isCorrectAnswer)
  ...
  pfaeMessage.textContent = isCorrectAnswer
...
Wie die Simulation zeigt, hängt die Aktualisierung der Fähigkeitsschätzung nicht allein davon ab, ob eine Antwort richtig oder falsch war. Entscheidend ist vielmehr, mit welcher Lernrate beide Fälle gewichtet werden. Um dieses Verhalten abzubilden, schlagen Papoušek et al. sowie Pelánek eine Erweiterung des Elo Ratings vor, die als Performance Factor Analysis Extended Elo (PFAE) bezeichnet wird. Die Grundidee besteht darin, korrekte und inkorrekte Antworten unterschiedlich zu behandeln. Während das klassische Elo Rating für beide Fälle denselben Aktualisierungsmechanismus verwendet, nutzt PFAE getrennte Lernraten für erfolgreiche und nicht erfolgreiche Bearbeitungen [@Papousek2014; @Pelanek2015; @Pelanek2016].
...
Dabei bezeichnet $\theta_{si,\text{alt}}$ die bisherige Fähigkeit des Lernenden $s$ für Aufgabe beziehungsweise Wissenskomponente $i$, während $\theta_{si,\text{neu}}$ den aktualisierten Wert beschreibt. Der Term $P_i$ steht für die erwartete Erfolgswahrscheinlichkeit der Aufgabe. Die Parameter $\gamma$ und $\delta$ beschreiben unterschiedliche Lernraten für korrekte beziehungsweise inkorrekte Antworten. Dadurch kann der erwartete Wissenszuwachs abhängig vom Ergebnis einer Aufgabe unterschiedlich modelliert werden [@Pelanek2016].
...
Während das ursprüngliche Elo Rating primär der Leistungsbewertung dient, rückt bei PFAE zunehmend die Modellierung von Lernprozessen in den Mittelpunkt. Die Erweiterung verdeutlicht damit eine zentrale Entwicklung adaptiver Lernsysteme: den Übergang von der reinen Wissensschätzung hin zur expliziten Modellierung individueller Lernverläufe [@Pelanek2016].

### Kombination mit adaptiven Wiederholungsstrategien

Die bisher vorgestellten Erweiterungen verändern das Elo Rating selbst, indem sie zusätzliche Informationen wie Unsicherheit, Bearbeitungszeiten oder mehrere Wissenskomponenten in die Fähigkeitsmodellierung einbeziehen. Eine andere Möglichkeit besteht darin, das Elo Rating mit weiteren adaptiven Verfahren zu kombinieren, die zusätzliche Aufgaben innerhalb eines adaptiven Lernsystems übernehmen.

Eine wichtige Fragestellung betrifft den Zeitpunkt der Wiederholung bereits bearbeiteter Aufgaben. Das Elo Rating schätzt den aktuellen Wissensstand eines Lernenden und die Schwierigkeit einer Aufgabe, trifft jedoch keine Aussage darüber, wann eine Aufgabe erneut bearbeitet werden sollte. Für diese Entscheidung können adaptive Wiederholungsverfahren eingesetzt werden. Ziel dieser Verfahren ist es, Wiederholungszeitpunkte individuell an den Lernfortschritt anzupassen, um bereits bearbeitete Lerninhalte rechtzeitig erneut bereitzustellen und dadurch den langfristigen Wissenserhalt zu unterstützen [@Chen2008].

Yang et al. kombinieren hierzu das Elo Rating mit einem sogenannten Learning Memory Cycle. Nach jeder bearbeiteten Aufgabe aktualisiert das System zunächst wie gewohnt die Fähigkeit des Lernenden sowie die Schwierigkeit der Aufgabe mithilfe des Elo Ratings. Anschließend wird zusätzlich ein individueller Memory Cycle berechnet, der bestimmt, nach welchem Zeitraum die Aufgabe erneut empfohlen werden soll. Dabei werden neben der aktuellen Fähigkeit und der Aufgabenschwierigkeit auch bisherige richtige und falsche Bearbeitungen berücksichtigt. Aufgaben mit einem kurzen Memory Cycle werden bevorzugt erneut empfohlen, während Aufgaben mit einem längeren Memory Cycle zunächst zurückgestellt werden. Dadurch verbindet das System die kontinuierliche Wissensschätzung des Elo Ratings mit einer adaptiven Wiederholungsplanung [@Yang2022]. 

::: {.content-visible when-format="pdf"}
**// Interaktive Simulation:** Dieser OJS-Block zeigt, wie nach Yang et al. (2022) ein Elo-Update mit einer Memory-Cycle-Aktualisierung kombiniert werden kann.
:::
...
Die Simulation verdeutlicht das Zusammenspiel beider Verfahren. Nach jeder Bearbeitung wird zunächst das Elo Rating angewendet, um die Fähigkeit des Lernenden sowie die Schwierigkeit der bearbeiteten Aufgabe anhand des Antwortergebnisses zu aktualisieren. Anschließend werden diese aktualisierten Werte genutzt, um den Memory Cycle zu berechnen. Dieser beschreibt, wie lange eine Aufgabe bis zur nächsten Wiederholung zurückgestellt werden kann. Korrekte Antworten führen dabei zu einer Verlängerung des Memory Cycles, während falsche Antworten ihn verkürzen und somit eine frühere Wiederholung bewirken [@Yang2022].

Das zugrunde liegende Aktualisierungsverfahren des Memory Cycles wird durch die folgenden Gleichungen beschrieben [@Yang2022].

Für eine korrekt beantwortete Aufgabe gilt:
...
Für eine falsch beantwortete Aufgabe gilt entsprechend:
...
Dabei bezeichnet $MC_{t}^{si}$ den bisherigen Memory Cycle des Lernenden $s$ für die Aufgabe $i$. Die Größen $\theta_s$ und $b_i$ entsprechen der durch das Elo Rating geschätzten Fähigkeit des Lernenden beziehungsweise der Schwierigkeit der Aufgabe. Die Funktionen $F_{o_{tsi}}$ und $F_{x_{tsi}}$ liefern die Fibonacci-Zahl der bisherigen Anzahl korrekt beziehungsweise falsch beantworteter Bearbeitungen der Aufgabe. Korrekte Antworten verlängern dadurch den Memory Cycle, während falsche Antworten ihn verkürzen [@Yang2022].

Anschaulich bedeutet dies, dass Aufgaben, die ein Lernender wiederholt korrekt bearbeitet, zunehmend seltener erneut empfohlen werden. Umgekehrt werden Aufgaben, die häufig falsch beantwortet werden, schneller erneut vorgeschlagen [@Yang2022].

Im Unterschied zum klassischen Elo Rating erweitert dieser Ansatz die Wissensschätzung um eine adaptive Wiederholungsplanung. Während das Elo Rating beschreibt, wie gut ein Lernender eine Aufgabe beherrscht, dient der Memory Cycle dazu, wann diese Aufgabe erneut bearbeitet werden sollte. Beide Verfahren übernehmen somit unterschiedliche Aufgaben innerhalb eines adaptiven Lernsystems und können miteinander kombiniert werden [@Yang2022].

## Feedback zur Lernressource

Wenn Sie die Lernressource bearbeitet haben, können Sie über den folgenden Fragebogen Rückmeldung geben. Die Antworten helfen dabei, die Verständlichkeit, Gestaltung und Nutzbarkeit der Lernressource zu bewerten und weiterzuentwickeln.

Die Teilnahme ist freiwillig und anonym.

[Zum Fragebogen](https://umfrage.fernuni-hagen.de/455125?lang=de)
